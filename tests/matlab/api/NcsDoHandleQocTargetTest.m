    ...
    methods (TestMethodSetup)
        ...
        function init(this)            
            ...
            this.ncs = NetworkedControlSystem(NcsControllerWithFilter(this.controller, this.filter, ...
                ...
                NcsSensor(this.sensor, 100), 'NCS', this.tickerInterval, this.plantTickerInterval, NetworkType.TcpLike);
            
            eventBasedController = EventBasedNcsControllerWithFilter(this.controller, this.filter, ...
                    LinearPlant(this.A, this.B, this.W), this.sensor, zeros(this.dimU, 1), ...
                    this.tickerInterval, [1/4 1/4 1/4 1/4]');
