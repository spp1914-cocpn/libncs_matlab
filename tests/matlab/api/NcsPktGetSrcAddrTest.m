classdef NcsPktGetSrcAddrTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function testInvalidDataPacket(this)
            expectedErrId = 'ncs_pktGetSrcAddr:InvalidPacket';
            
            invalidPacket = this; % not a data packet
            this.verifyError(@() ncs_pktGetSrcAddr(invalidPacket), expectedErrId);
